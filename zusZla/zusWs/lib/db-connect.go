...
type Ezla struct {
	...
	StacjonarnyZOZ           sql.NullBool   `json:"stacjonarny_ZOZ"`
	NieInformowacPlatnika    sql.NullBool   `json:"nie_informowac_platnika"`
	NipPlacowki              sql.NullInt64  `json:"nip_placowki"`
...
//GetDocParms return document value from database
func GetDocParms(idIDEzwolnienia int) Ezla {
